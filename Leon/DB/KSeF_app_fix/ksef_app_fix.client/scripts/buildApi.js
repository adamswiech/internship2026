...
// async function getEndpoints(paths) {
//     return Object.entries(paths).flatMap(([pathKey, methods]) => {
//         const methodEntries = Object.entries(methods).map(([methodKey, details]) => {
//             const tag = details.tags ?? [];
//             const params = (details.parameters ?? []).map(param => ({
//                 name: param.name,
//                 in: param.in,
...
//                 requestBody = Object.entries(details.requestBody.content).map(([contentType, contentObj]) => {
//                     const schema = extractSchema(contentObj.schema);
...
//                 const content = {};
//                 if (response.content) {
//                     for (const [ctype, cobj] of Object.entries(response.content)) {
//                         content[ctype] = extractSchema(cobj.schema);
//                     }
//                 }
//                 return {
//                     code,
...
//                 };
//             });
//             return { method: methodKey, tag, params, requestBody, responses };
//         });
//         return { path: pathKey, methods: methodEntries };
//     });
//}
